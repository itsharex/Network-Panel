<template>
			...
			<div style="width: fit-content;display: block;margin-top:2ch;margin-left: auto;margin-right: auto;">
				...
				<a class="button" v-if="isRuning" @click="isRuning = false" circle>
					<svg t="1694958268344" fill="white" style="width: 80px;margin-top: -30px;" viewBox="0 0 1024 1024"
						version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="7667" width="200" height="200">
						<path
	...
	<audio v-if="isMobile && runBackground" @canplay="()=>{if(isRuning)audioDom.play()}"
		@pause="()=>{if(runBackground)isRuning=false}" @play="isRuning=true" controls loop ref="audioDom"
		style="display:none">
